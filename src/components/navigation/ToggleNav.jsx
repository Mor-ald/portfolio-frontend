        ...
        <>
            ...
            <Sidebar visible={ toggleBar } onHide={ () => setToggleBar(false) }>
                <div className={ styles.verticalNav }>
                    <Link to="/" className={ styles.link } onClick={ () => setToggleBar(false) }>
                        <i className={"pi pi-home"} style={{marginRight: "0.5rem"}} />
                        Домашняя страница
                    </Link>
                    <Link to="stack" className={ styles.link } onClick={ () => setToggleBar(false) }>
                        <i className={"pi pi-cog"} style={{marginRight: "0.5rem"}} />
                        Стек технологий
                    </Link>
                    <Link to="works" className={ styles.link } onClick={ () => setToggleBar(false) }>
                        <i className={"pi pi-book"} style={{marginRight: "0.5rem"}} />
                        Выполненные работы
                    </Link>
                </div>
                    ...
                    <a href="https://t.me/Mor_Ald" className={styles.tel}>
                        <svg width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_25_4236)">
                                <path d="M27.5643 2.6615L0.985699 12.9638C-0.0838717 13.4436 -0.44563 14.4043 0.727183 14.9258L7.54574 17.1039L24.0321 6.86227C24.9323 6.21932 25.8539 6.39076 25.0609 7.09805L10.9013 19.9849L10.4565 25.4385C10.8685 26.2806 11.6228 26.2845 12.104 25.866L16.0214 22.1401L22.7307 27.1901C24.289 28.1174 25.1369 27.519 25.4722 25.8193L29.8729 4.87383C30.3298 2.78174 29.5506 1.85994 27.5643 2.6615Z" fill="white"/>
                            </g>
                            <defs>
